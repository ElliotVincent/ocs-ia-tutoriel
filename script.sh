...
GIT_REPO=ocs-ia-tutoriel
git clone --depth 1 https://github.com/ElliotVincent/${GIT_REPO}.git
...
echo "c.LabApp.default_url = '/lab/tree/${GIT_REPO}/tutoriel_classification_sols.ipynb'" >> /home/onyxia/.jupyter/jupyter_server_config.py
